...
# MODEL = "gpt-4.1-nano"
MODEL = "openrouter/gpt-oss-20b:free" # rate limited
...
{{
  ...
  "relevance": 5.0
    ...
    # judge_response = completion(model=MODEL, messages=judge_messages, response_format=AnswerEval, api_base=BASE_URL, api_key=OPENROUTER_API_KEY)

    # answer_eval = AnswerEval.model_validate_json(judge_response.choices[0].message.content)

    # Call LLM judge WITHOUT response_format
